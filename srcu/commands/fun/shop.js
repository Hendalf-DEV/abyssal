...
module.exports = {
    ...
    async execute(interaction) {
        ...
        collector.on('collect', async i => {
            ...
            // Добавить новую проверку перед проверкой на 'buyRole'
            if (i.customId.startsWith('buyBackground')) {
                ...
                await addUserProduct(userId, background.id); // добавить продукт к пользователю
            ...
            // Следующая проверка начинается с 'buyRole' только после проверки на 'buyBackground'
            ...
            await addUserProduct(userId, role.id); // добавить продукт к пользователю
